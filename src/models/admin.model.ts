...
//     return rows;
// };
// export async function delStudentInStudent(UID: number) {
//     const sql = `DELETE FROM students WHERE UID = '${UID}'`
//     const [result, fields] = await load(sql);
//     return result;
// };
// export async function delStudentInUsers(UID: number) {
//     const sql = `DELETE FROM users WHERE UID = '${UID}'`
//     const [result, fields] = await load(sql);
//     return result;
// };
// export async function blockStudent(UID: number, block: number) {
...
//     return result;
// };
// export async function editStudent(UID: number, name: string, DOB: string, Gender: number) {
...
//     return result;
// };
// export async function delTeacherInTeacher(UID: number) {
//     const sql = `DELETE FROM teachers WHERE UID = '${UID}'`
//     const [result, fields] = await load(sql);
//     return result;
// };
// export async function delTeacherInUsers(UID: number) {
//     const sql = `DELETE FROM users WHERE UID = '${UID}'`
//     const [result, fields] = await load(sql);
//     return result;
// };
// export async function editTeacher(UID: number, name: string, DOB: string, Gender: number) {
...
//     return result;
// };
// export async function blockTeacher(UID: number, block: number) {
//     const sql = `UPDATE users
//         SET block = ${block}
//         WHERE UID = '${UID}'`;
//     const [result, fields] = await load(sql);
